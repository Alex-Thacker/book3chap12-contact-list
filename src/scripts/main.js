...
// console.log(Object.entries(mustang))
...
import garageFactory from "./garageFactory"
...
garageFactory.store(mustang)
garageFactory.store(accord)
garageFactory.store(santafe)
garageFactory.store(sierra)

console.table(garageFactory.inventory())
console.table(garageFactory.retrieve(sierra))
